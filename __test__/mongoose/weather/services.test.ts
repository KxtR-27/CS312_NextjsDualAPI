...
import { deleteByZip, findByZip, storeDocument, updateByZip } from "../../../mongoose/weather/services";
...
describe("the weather services", () => {
	...
	describe("API updateByZip", () => {
		...
		test("passes the zip and data to Model.updateOne()", async () => {
	...
	describe("API deleteByZip", () => {
		...
		test("passes the zipcode to Model.deleteOne()", async () => {
